  ...
  <div class="content-page">
    <div class="content-nav">
      <el-breadcrumb class="breadcrumb" separator="/">
        <el-breadcrumb-item>Youco商城主页</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="content-main clearfix">
      <div class="notice">
        <div class="r">欢迎来到Youco商城后台系统</div>
      ...
      <div class="github">
        <a target="_blank" href="https://gitee.com/Heng_XIang">Youco商城</a>
        <div class="l">8亿用户都在使用的小程序商城</div>
      </div>
