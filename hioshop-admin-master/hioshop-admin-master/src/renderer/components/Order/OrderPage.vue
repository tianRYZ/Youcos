          ...
          <div v-for="item in tableData" class="list-wrap clearfix">
            <div class="header clearfix">
              ...
              <div class="right">
                ...
                <div class="price-wrap">当前合计{{item.actual_price}}元</div>
              </div>
            </div>
            <div class="content-wrap clearfix">
              ...
              <div class="main">
                ...
                <el-input class="admin-memo" type="textarea" @blur='changeMemo(item.id,item.admin_memo)' v-model="item.admin_memo" placeholder="备注"></el-input>
              </div>
              <div class="right">
                <el-button v-if="item.print_status == 1 && item.order_status == 300" class="d-btn" type="primary" @click="deliveryConfirm(item.id)" size="mini">发货
                </el-button>
    ...
    <el-dialog title="打印快递单" :visible.sync="dialogFormVisible">
      <el-form :model="dform">
        ...
        <el-form-item label="保价金额及提醒" v-if="expressType == 1">
          <el-input-number :mini="1" :max="9999" v-model="orderInfo.express_value" @change="changeExpressValue(orderInfo)" @blur="changeExpressValue(orderInfo)" placeholder="请输入保价金额"></el-input-number>
    ...
    <el-dialog title="修改价格" :visible.sync="dialogPriceVisible">
      <el-form :model="orderInfo">
        ...
        <el-form-item label="修改商品价格:">
          <el-input-number @change="goodsPriceChange" :min="0" :max="99999999" v-model="orderInfo.goods_price" auto-complete="off" placeholder="请输入商品价格"></el-input-number>
        </el-form-item>
        <el-form-item label="修改快递价格:">
          <el-input-number @change="freightPriceChange" :min="0" :max="99999999" v-model="orderInfo.freight_price" auto-complete="off" placeholder="请输入修改后的快递"></el-input-number>
        </el-form-item>
...
export default {
  data () {
    return {
      ...
      printMiandan: false,
      rawHtml: '',
      testApi: 'http://sandboxapi.kdndiao.com:8080/kdniaosandbox/gateway/exterfaceInvoke.json',
